...
// Org1
export const CONNECTION_PROFILE_ORG1 =
    "../../test-network/organizations/peerOrganizations/org1.example.com/connection-org1.json";
export const ORG1_HOSTNAME = "ca.org1.example.com";
export const MSP_ORG_1 = "Org1MSP";

// Org2
export const CONNECTION_PROFILE_ORG2 =
    "../../test-network/organizations/peerOrganizations/org2.example.com/connection-org2.json";
export const ORG2_HOSTNAME = "ca.org2.example.com";
export const MSP_ORG_2 = "Org2MSP";
